...
# Schritt 4: Berechne den Durchschnitt der Spiele pro Spieler
average_games_count = games_count_df['games_count'].mean()

print("Durchschnittliche Anzahl der Spiele nach einem Gewinn mit dem gleichen Betrag in ETH:", average_games_count)
